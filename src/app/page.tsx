...
const projects = [
  ...
  },
  {
    id: 2,
    company: "TeamFresh",
    title: "RDMS / TIMF O:da",
    subtitle: "기업 유통/물류 전산 통합 시스템 & 식자재 주문 플랫폼",
    ...
    role: [
      ...
      "QC / 현장 베타테스트",
      "서비스 운영 및 고도화 기획",
      "TIMF O:da 상품 조회 프로세스 및 UI 초안 기획",
      "TIMF O:da QC / 현장 안정화 교육",
    ],
    tools: ["Figma", "JIRA", "Confluence", "Notion"],
    summary:
      "유통 사업부의 재고 수불 불일치와 운영 리소스 낭비 문제를 해결하기 위한 유통 전산 통합 시스템. 6개 운영 센터, 7개 파트의 사용성을 반영한 ERP/OMS/WMS/TMS/CRM 5개 모듈, 46개 관리 메뉴로 구성. 식자재 새벽배송 주문 플랫폼(TIMF O:da)도 함께 기획하여 유통&물류 시스템과 동시 배포.",
    process: [
      "기능 및 화면 설계",
      "운영 정책 정립",
      "CBT & OBT",
    ...
    results: [
      "휴먼 에러 제거로 재고 및 단가 정합성 증가, 자산 관리 용이",
      "새로운 사업 카테고리와 프로세스 도입 기반 마련",
      "실시간 작업 현황 및 재고 반영으로 즉각적인 모니터링 가능",
      "TIMF O:da 유통&물류 시스템 동시 배포 완료",
    ],
    roadmap: [
